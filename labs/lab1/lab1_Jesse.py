...
'''
Jesse, the code is good.  I would have liked to see
more on your computational thinking on the top of each
problem.  Break down the problem into logical steps (decompose)
add any patterns you see that might be helpful.  Basically, explain
...
def text_analysis():
    ...
    for char in text:                       # USE CHAR TO GO THROUGH INPUT 1 LETTER AT A TIME
        if char.isalpha(): letters += 1     # .isalpha() TO DETERMINE IF THE CHARACTER IS A LETTER
        elif char == " ":  words += 1 
